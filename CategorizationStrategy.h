 ...
 * based on city growth metrics managed by the `Government` class. Derived classes 
...
public:
     ...
     * specific categorization logic based on growth factors (e.g., economy, population).
     * 
